...
namespace Org.Reddragonit.VueJSMVCDotNet
{
    ...
    public class VueHandlerOptions
    {
        ...
        public VueHandlerOptions(ISecureSessionFactory sessionFactory, ILogWriter logWriter=null, string baseURL=null)
        {
    ...
    /// </summary>
    public class VueHandlerMiddleware
    {
        ...
        public VueHandlerMiddleware(RequestDelegate next,VueHandlerOptions options)
        {
            _next=next;
            _options=options;
            _handler = new ModelRequestHandler(_options.LogWriter,options.BaseURL);
        }
