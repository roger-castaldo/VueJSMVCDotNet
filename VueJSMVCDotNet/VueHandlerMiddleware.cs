...
namespace Org.Reddragonit.VueJSMVCDotNet
{
    ...
    public class MessageHandlerOptions
    {
        ...
        /// </summary>
        /// <param name="fileProvider">A file provider used to search for and load message directories</param>
        /// <param name="baseURL">The base url for the messages to exist inside</param>
        public MessageHandlerOptions(IFileProvider fileProvider,string baseURL)
        {
    ...
    public class VueMiddlewareOptions
    {
        ...
        public VueMiddlewareOptions(VueModelsOptions modelsOptions=null, MessageHandlerOptions messageOptions=null,ILogWriter logWriter=null)
        {
    ...
    public class VueMiddleware : IDisposable
    {
        ...
        public VueMiddleware(RequestDelegate next, VueMiddlewareOptions options)
        {
            _next=next;
            _options=options;
            _modelHandler = (_options.VueModelsOptions==null ? null : new ModelRequestHandler(_options.LogWriter,options.VueModelsOptions.BaseURL,options.VueModelsOptions.IgnoreInvalidModels));
            _messageHandler = (_options.MessageOptions==null ? null : new MessagesHandler(options.MessageOptions.FileProvider, options.MessageOptions.BaseURL));
        }
