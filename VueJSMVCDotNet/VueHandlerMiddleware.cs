...
namespace Org.Reddragonit.VueJSMVCDotNet
{
    ...
    public class VueMiddlewareOptions
    {
        ...
        public VueMiddlewareOptions(VueModelsOptions modelsOptions=null, IFileProvider fileProvider = null, MessageHandlerOptions messageOptions=null,ILogWriter logWriter=null,string vueImportPath=null,VueFilesHandlerOptions vueFilesOptions=null)
        {
    ...
    public class VueMiddleware : IDisposable
    {
        ...
        public VueMiddleware(RequestDelegate next, VueMiddlewareOptions options)
        {
            ...
            _vueFileHandler = (_options.VueFilesOptions==null ? null : new VueFilesHandler(options.FileProvider, options.VueFilesOptions.BaseURL, options.LogWriter,options.VueImportPath));
        }
