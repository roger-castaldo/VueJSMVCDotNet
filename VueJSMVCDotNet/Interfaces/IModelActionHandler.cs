...
namespace Org.Reddragonit.VueJSMVCDotNet.Interfaces
{
    internal interface IModelActionHandler
    {
        ...
        Task InvokeWithoutLoad(string url, ModelRequestData request, HttpContext context, IModel model=null, Func<IModel, object, object[],MethodInfo, object> extractResponse = null);
