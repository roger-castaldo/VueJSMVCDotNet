...
{
    internal class TestApplicationFactory(bool ignoreInvalidModels, ILogger logWriter, IMemoryCache cache, IDataStore store, SecureSession session) : WebApplicationFactory<Program>
    {
